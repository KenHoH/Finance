...
import { RespondFriendRequestDto } from '../core/app/respond-friend-request.dto.js';
...
export class FriendController {
  ...
  @Get('summary')
  @ApiOperation({
    summary: 'Get friends, sent requests, and received requests in one call',
  })
  async getSummary(@Req() req: Request) {
    const userId = req.user.sub;
    return this.friendService.getSummary(userId);
  }
