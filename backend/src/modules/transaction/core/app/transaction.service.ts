...
export class TransactionService {
  ...
  async create(userId: string, dto: CreateTransactionDto) {
    ...
    this.logger.debug(
      `Created transaction for user ${userId} - Amount: ${transaction.amount}, Type: ${transaction.type}, Category: ${transaction.categoryId}, Date: ${transaction.date.toISOString()}`,
    );
  ...
  public async getTotalSpentByDayByCategory(
    userId: string,
    categoryId: string,
    date: Date,
  ): Promise<number> {
  ...
  public async getTotalSpentThisMonth(
    userId: string,
    startDate: string,
    endDate: string,
  ): Promise<number> {
  ...
  public async getTotalSpentThisMonthByCategory(
    userId: string,
    categoryId: string,
    startDate: string,
    endDate: string,
  ...
  async update(userId: string, id: string, dto: UpdateTransactionDto) {
    ...
    await this.activityLogService.logActivity(
      ...
      'Transaction',
      id,
      { amount: Number(updated.amount), type: updated.type },
    );
