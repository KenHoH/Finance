...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:flex h-[calc(100vh-2rem)] w-[260px] flex-col fixed top-4 left-4 z-50 rounded-[2rem] shadow-2xl overflow-hidden">
      ...
      {/* Mobile Glass Topbar */}
      <div className="lg:hidden fixed top-0 inset-x-0 h-16 border-x-0 border-t-0 flex items-center justify-between px-4 z-50">
      ...
      <div
        className={cn(
          "lg:hidden fixed inset-y-4 left-4 w-[calc(100%-2rem)] max-w-sm rounded-[2rem] shadow-2xl z-[70] transform transition-transform duration-300 ease-out flex flex-col overflow-hidden",
