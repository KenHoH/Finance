...
export function getCategoryIcon(name: string | null | undefined): string {
  ...
  if(n.includes("groceries")) return "/groceries.png";
  if(n.includes("food") || n.includes("dining") || n.includes("restaurant") || n.includes("drink")) return "/food.png";
  ...
  if(n === "investment") return "/investment.png";
  if(n.includes("invest") || n.includes("dividend") || n.includes("interest")) return "/invest-stocks.png";
  if(n.includes("gift") || n.includes("present")) return "/gift.png";
  if(n.includes("donation")) return "/salary.png";
  ...
  if(n.includes("other")) return "/others.png";
