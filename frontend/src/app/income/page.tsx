                  ...
                  {paginatedData.map((t, idx) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5">
                        <span className="inline-flex items-center justify-center gap-2 px-4 h-10 w-[160px] rounded-full text-sm font-bold bg-primary/10 text-primary border border-primary/20">
                          {(() => {
                            const LucideIcon = getLucideIcon(t.category?.icon);
                            if(LucideIcon) return <LucideIcon className="w-9 h-9 shrink-0" strokeWidth={2.5} />;
